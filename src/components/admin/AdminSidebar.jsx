...
const AdminSidebar = ({ activeTab, setActiveTab, isOpen, setIsOpen }) => {
    ...
    const transportItemIds = ['transport-overview', 'transport-vehicles', 'transport-cities', 'transport-bookings', 'transport-content', 'transport-settings', 'car-management', 'car-bookings', 'cruise-bookings', 'cycle-bookings'];
