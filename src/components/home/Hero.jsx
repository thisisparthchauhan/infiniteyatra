...
const popularDestinations = [
    ...
    "Badrinath, Uttarakhand", "Char Dham, Uttarakhand",
    "Gangotri, Uttarakhand",
    "Haridwar, Uttarakhand", "Hyderabad, India",
    "Kedarnath, Uttarakhand", "Kedarkantha, Uttarakhand",
    "Chopta, Uttarakhand",
...
const Hero = () => {
    ...
    const words = ["Yatra", "Journey", "Adventure", "Escape", "Experience", "Odyssey"];
    ...
    return (
        <div className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center text-white flex flex-col items-center">
                ...
                >
                    Plan spiritual yatras, Himalayan treks and curated journeys — with Infinite Yatra.
                </motion.p>
            ...
            <motion.button
                ...
                className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 opacity-50 hover:opacity-100 transition-opacity bg-transparent border-0 cursor-pointer"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
