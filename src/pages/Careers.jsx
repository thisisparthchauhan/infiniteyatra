                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="space-y-4">
                        {openings.map((job, index) => (
                            ...
                            >
                                ...
                                <a
                                    href="mailto:info@infiniteyatra.com"
                    ...
                    <div className="mt-12 text-center bg-blue-900/20 p-8 rounded-2xl border border-blue-500/20">
                        ...
                        <p className="text-slate-400 mb-6">
                            We are always looking for talented people. Send your resume to <span className="font-semibold text-blue-400">info@infiniteyatra.com</span>
                        </p>
                        <a
                            href="mailto:info@infiniteyatra.com"
